...
export const statusLabels: Record<ProjectStatus, string> = { todo: '待办', in_progress: '进行中', done: '已完成', blocked: '已阻塞', cancelled: '已取消' };
export const statusColors: Record<ProjectStatus, string> = { todo: 'bg-gray-100 text-gray-600', in_progress: 'bg-blue-100 text-blue-700', done: 'bg-green-100 text-green-700', blocked: 'bg-amber-100 text-amber-700', cancelled: 'bg-red-100 text-red-600' };
...
export const statusOptions: Array<{ value: string; label: string }> = [
  { value: 'all', label: '全部状态' }, { value: 'todo', label: '待办' }, { value: 'in_progress', label: '进行中' },
  { value: 'done', label: '已完成' }, { value: 'blocked', label: '已阻塞' },
];
