...
export function generateMembers(): Member[] {
  return [
    { id: 'm01', name: '张明', nickname: '明哥', wechatId: 'zhangming_wx', phone: '13800001001', role: 'admin', department: '管理层', avatar: '张明', email: 'zhangming@team.com', status: 'active', joinDate: '2024-01-15', permissions: [], teamId: '__default__' },
    { id: 'm02', name: '李华', nickname: '华子', wechatId: 'lihua_wx', phone: '13800001002', role: 'admin', department: '管理层', avatar: '李华', email: 'lihua@team.com', status: 'active', joinDate: '2024-01-20', permissions: [], teamId: '__default__' },
    { id: 'm03', name: '王芳', nickname: '芳姐', wechatId: 'wangfang_wx', phone: '13800001003', role: 'manager', department: '产品部', avatar: '王芳', email: 'wangfang@team.com', status: 'active', joinDate: '2024-02-01', permissions: [], teamId: '__default__' },
    { id: 'm04', name: '赵强', nickname: '强哥', wechatId: 'zhaoqiang_wx', phone: '13800001004', role: 'manager', department: '技术部', avatar: '赵强', email: 'zhaoqiang@team.com', status: 'active', joinDate: '2024-02-10', permissions: [], teamId: '__default__' },
    { id: 'm05', name: '陈丽', nickname: '丽姐', wechatId: 'chenli_wx', phone: '13800001005', role: 'manager', department: '市场部', avatar: '陈丽', email: 'chenli@team.com', status: 'active', joinDate: '2024-02-15', permissions: [], teamId: '__default__' },
    { id: 'm06', name: '刘伟', nickname: '伟哥', wechatId: 'liuwei_wx', phone: '13800001006', role: 'manager', department: '运营部', avatar: '刘伟', email: 'liuwei@team.com', status: 'active', joinDate: '2024-03-01', permissions: [], teamId: '__default__' },
    { id: 'm07', name: '周雪', nickname: '雪姐', wechatId: 'zhouxue_wx', phone: '13800001007', role: 'manager', department: '客服部', avatar: '周雪', email: 'zhouxue@team.com', status: 'active', joinDate: '2024-03-10', permissions: [], teamId: '__default__' },
    { id: 'm08', name: '孙鹏', nickname: '鹏鹏', wechatId: 'sunpeng_wx', phone: '13800001008', role: 'member', department: '技术部', avatar: '孙鹏', email: 'sunpeng@team.com', status: 'active', joinDate: '2024-03-15', permissions: [], teamId: '__default__' },
    { id: 'm09', name: '吴佳', nickname: '佳佳', wechatId: 'wujia_wx', phone: '13800001009', role: 'member', department: '技术部', avatar: '吴佳', email: 'wujia@team.com', status: 'active', joinDate: '2024-04-01', permissions: [], teamId: '__default__' },
    { id: 'm10', name: '郑凯', nickname: '凯哥', wechatId: 'zhengkai_wx', phone: '13800001010', role: 'member', department: '技术部', avatar: '郑凯', email: 'zhengkai@team.com', status: 'active', joinDate: '2024-04-10', permissions: [], teamId: '__default__' },
    { id: 'm11', name: '黄蕾', nickname: '蕾蕾', wechatId: 'huanglei_wx', phone: '13800001011', role: 'member', department: '产品部', avatar: '黄蕾', email: 'huanglei@team.com', status: 'active', joinDate: '2024-04-15', permissions: [], teamId: '__default__' },
    { id: 'm12', name: '林杰', nickname: '杰哥', wechatId: 'linjie_wx', phone: '13800001012', role: 'member', department: '产品部', avatar: '林杰', email: 'linjie@team.com', status: 'active', joinDate: '2024-05-01', permissions: [], teamId: '__default__' },
    { id: 'm13', name: '杨帆', nickname: '帆帆', wechatId: 'yangfan_wx', phone: '13800001013', role: 'member', department: '市场部', avatar: '杨帆', email: 'yangfan@team.com', status: 'active', joinDate: '2024-05-10', permissions: [], teamId: '__default__' },
    { id: 'm14', name: '徐静', nickname: '静静', wechatId: 'xujing_wx', phone: '13800001014', role: 'member', department: '市场部', avatar: '徐静', email: 'xujing@team.com', status: 'active', joinDate: '2024-05-15', permissions: [], teamId: '__default__' },
    { id: 'm15', name: '何磊', nickname: '磊哥', wechatId: 'helei_wx', phone: '13800001015', role: 'member', department: '运营部', avatar: '何磊', email: 'helei@team.com', status: 'active', joinDate: '2024-06-01', permissions: [], teamId: '__default__' },
    { id: 'm16', name: '马婷', nickname: '婷婷', wechatId: 'mating_wx', phone: '13800001016', role: 'member', department: '运营部', avatar: '马婷', email: 'mating@team.com', status: 'active', joinDate: '2024-06-10', permissions: [], teamId: '__default__' },
    { id: 'm17', name: '罗浩', nickname: '浩子', wechatId: 'luohao_wx', phone: '13800001017', role: 'member', department: '客服部', avatar: '罗浩', email: 'luohao@team.com', status: 'active', joinDate: '2024-06-15', permissions: [], teamId: '__default__' },
    { id: 'm18', name: '谢芳', nickname: '芳芳', wechatId: 'xiefang_wx', phone: '13800001018', role: 'member', department: '客服部', avatar: '谢芳', email: 'xiefang@team.com', status: 'active', joinDate: '2024-07-01', permissions: [], teamId: '__default__' },
    { id: 'm19', name: '韩超', nickname: '超哥', wechatId: 'hanchao_wx', phone: '13800001019', role: 'member', department: '财务部', avatar: '韩超', email: 'hanchao@team.com', status: 'active', joinDate: '2024-07-10', permissions: [], teamId: '__default__' },
    { id: 'm20', name: '唐敏', nickname: '敏敏', wechatId: 'tangmin_wx', phone: '13800001020', role: 'member', department: '财务部', avatar: '唐敏', email: 'tangmin@team.com', status: 'active', joinDate: '2024-07-15', permissions: [], teamId: '__default__' },
    { id: 'm21', name: '冯涛', nickname: '涛哥', wechatId: 'fengtao_wx', phone: '13800001021', role: 'member', department: '人力资源部', avatar: '冯涛', email: 'fengtao@team.com', status: 'active', joinDate: '2024-08-01', permissions: [], teamId: '__default__' },
    { id: 'm22', name: '曹颖', nickname: '颖颖', wechatId: 'caoying_wx', phone: '13800001022', role: 'member', department: '人力资源部', avatar: '曹颖', email: 'caoying@team.com', status: 'active', joinDate: '2024-08-10', permissions: [], teamId: '__default__' },
  ];
}
  ...
  function flattenTemplates(templates: GoalTemplate[], parentId: string | null, level: number) {
    templates.forEach(t => {
      ...
      const goal: Goal = {
        ...
        appType: 'personal', discussionThreadId: null, summary: '', teamId: '__default__',
  ...
  projects.forEach(project => {
    ...
    for (let i = 0; i < taskCount; i++) {
      ...
      tasks.push({
        ...
        appType: 'personal', discussionThreadId: null, summary: '', teamId: '__default__', blockedBy: [], sprintId: null,
        dueDate,
